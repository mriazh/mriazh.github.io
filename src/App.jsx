      ...
      <main>
        ...
        <section id="about" className="about section fade-in">
          ...
          <div className="about-grid">
            <div className="about-card card">
              ...
              <p>
                Managing network monitoring, topology updates, switch patching,
                VLAN configuration, and server rack maintenance in an enterprise
                airport environment.
              </p>
            </div>
            <div className="about-card card">
              ...
              <h3>Wireless &amp; LAN</h3>
              <p>
                Experienced in deploying and configuring new Wi-Fi and LAN
                devices, as well as troubleshooting complex network connections
                across the facility.
              </p>
            </div>
            <div className="about-card card">
              ...
              <p>
                Building specialized automation tools with Python to speed up
                MRTG monitoring, data extraction via OCR, and automated
                reporting workflows.
              </p>
            </div>
          </div>
          ...
          <div className="skills-container">
            <div className="skill-category card">
              ...
              <div className="skill-tags">
                ...
                <span className="tag">
                  <i className="devicon-bash-plain"></i> Bash
                </span>
              </div>
            </div>
            <div className="skill-category card">
              ...
              <div className="skill-tags">
                ...
                <span className="tag">
                  <i className="devicon-ansible-plain"></i> Network Automation
                </span>
              </div>
            </div>
            <div className="skill-category card">
              ...
              <div className="skill-tags">
                <span className="tag">
                  <i className="devicon-selenium-original"></i> Selenium
                </span>
                <span className="tag">
                  <i className="devicon-python-plain"></i> Tkinter
                </span>
                <span className="tag">
                  <i className="devicon-sqlite-plain"></i> SQLite
                </span>
                <span className="tag">
        ...
        <section id="projects" className="projects section fade-in">
          ...
          <div className="projects-grid">
            <a
              href="https://github.com/mriazh/Automated-Daily-MRTG-Telkom-in-GMF"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <p>
                Automated daily MRTG graph screenshot capture from TelkomCare
                with OCR validation and auto-retry mechanism.
              </p>
              <span className="tech-used">Python · Selenium · OCR</span>
            </a>
            <a
              href="https://github.com/mriazh/Automated-MRTG-to-Excel-Report"
              target="_blank"
              rel="noreferrer"
              className="project-card card"
            >
              ...
              <p>
                All-in-one automation: Extracts bandwidth data via OCR and
                seamlessly inserts perfectly resized MRTG graph images into
                monthly Excel templates.
              </p>
              <span className="tech-used">Python · OCR · Excel Automation</span>
            </a>
            <a
              href="https://github.com/mriazh/Automated-MRTG-Monitor"
              target="_blank"
              rel="noreferrer"
              className="project-card card"
            >
              <h3>Automated MRTG Monitor</h3>
              <p>
                A robust desktop application for real-time network bandwidth
                graph monitoring with auto-refresh, dark/light mode, crash
                auto-recovery, and Telegram alert integration.
              </p>
              <span className="tech-used">Python · PySide6 · Selenium</span>
            </a>
          </div>
        </section>
        ...
        <section id="contact" className="contact section fade-in">
          ...
          <div className="contact-card card">
            <p>
              I'm always open to discussing networking, automation, or new
              opportunities.
            </p>
            <div className="social-links">
              <a
                href="https://github.com/mriazh"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/mriazh"
                target="_blank"
                rel="noreferrer"
                className="social-btn"
                aria-label="LinkedIn"
              ...
              <a
                href="https://www.instagram.com/rapzzzzy"
                target="_blank"
                rel="noreferrer"
                className="social-btn"
              ...
              <a
                href="mailto:mriyadhazhar@gmail.com"
                className="social-btn"
                aria-label="Email"
              >
                <svg viewBox="0 0 24 24" fill="currentColor">
